...
public class CommonController {
    ...
    @GetMapping("/comments")
    public Result listComments(CommentVO commentVO) {
    ...
    public Result getTouristInfo() {
        return Result.success(commentService.getTouristInfo());
    }
    ...
    @PostMapping("/tourist")
    public Result reportTourist(@RequestBody TouristVO touristVO) {
        commentService.reportTourist(touristVO);
        return Result.success();
    }
