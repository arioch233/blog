...
export default {
  ...
  methods: {
    ...
    saveOrUpdateMenu() {
      ...
      this.request.post("/admin/menu/update", this.menuForm).then((data) => {
        if (data.code === 200) {
          this.$notify.success({
            title: "成功",
            message: "操作成功",
    ...
    deleteMenu(id) {
      this.request.delete("/admin/menu/delete/" + id).then((data) => {
        if (data.code === 200) {
          this.$notify.success({
            title: "成功",
            message: "删除成功",
    ...
    changeDisable(menu) {
      this.request.post("/admin/menu/update", menu).then((data) => {
        if (data.code === 200) {
          this.$notify.success({
            title: "成功",
            message: "操作成功",
