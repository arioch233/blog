...
export default {
  ...
  methods: {
    ...
    listRoles() {
      ...
      this.request.get("/admin/resource/role").then((data) => {
        this.resourceList = data.data;
      });
      this.request.get("/admin/menu/role").then((data) => {
    ...
    deleteRoles(id) {
      ...
      this.request.delete("/admin/role/delete", param).then((data) => {
        if (data.code === 200) {
          this.$notify.success({
            title: "成功",
    ...
    saveOrUpdateRoleResource() {
      ...
      this.request.post("/admin/role/update", this.roleForm).then((data) => {
        if (data.code === 200) {
          this.$notify.success({
            title: "成功",
            message: data.message,
    ...
    changeDisable(role) {
      ...
      this.request.post("/admin/role/update/disable", roleForm).then((data) => {
        if (data.code === 200) {
          this.$notify.success({
            title: "成功",
            message: data.message,
