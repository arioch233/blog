      ...
      <el-tab-pane label="社交信息" name="notice">
        <el-form label-width="70px" :model="websiteConfigForm">
          <el-checkbox-group v-model="websiteConfigForm.socialUrlList">
            ...
            <el-form-item label="Gitea">
              <el-input
                v-model="websiteConfigForm.gitea"
                size="small"
                style="width: 400px; margin-right: 1rem"
              />
              <el-checkbox label="gitea">是否展示</el-checkbox>
            </el-form-item>
            <el-button
              type="primary"
              size="medium"
      ...
      <el-tab-pane label="其他设置" name="password">
        ...
        >
          ...
          <el-form-item label="打赏状态">
            <el-radio-group disabled v-model="websiteConfigForm.isReward">
              <el-radio :label="0">关闭</el-radio>
              <el-radio :label="1">开启</el-radio>
            </el-radio-group>
          </el-form-item>
          <el-row
            style="width: 600px"
            v-show="websiteConfigForm.isReward === 1"
          >
            <el-col :md="12">
...
export default {
  ...
  methods: {
    getWebsiteConfig() {
      this.request.get("/admin/config/website").then((data) => {
    ...
    updateWebsiteConfig() {
      this.request
        .put("/admin/config/website/update", this.websiteConfigForm)
        .then((data) => {
          if (data.code === 200) {
            this.$notify.success({
              title: "成功",
