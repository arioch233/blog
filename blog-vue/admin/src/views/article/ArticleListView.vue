...
export default {
  ...
  methods: {
    ...
    updateArticleDelete(id) {
      ...
      this.request.put("/admin/article/delete/logic", param).then((data) => {
        if (data.code === 200) {
          this.$notify.success({
            title: "成功",
    ...
    deleteArticles(id) {
      ...
      this.request.delete("/admin/article/delete", param).then((data) => {
        if (data.code === 200) {
          this.$notify.success({
            title: "成功",
            message: data.message,
    ...
    exportArticles(id) {
      ...
      console.log(param);
      this.request.post("/admin/article/export", param).then((data) => {
        if (data.code === 200) {
          this.$notify.success({
            title: "成功",
            message: data.message,
    ...
    listCategories() {
      this.request.get("/admin/category/search").then((data) => {
        this.categoryList = data.data;
      });
    },
    listTags() {
      this.request.get("/admin/tag/search").then((data) => {
